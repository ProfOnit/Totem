...
export default class PlatformerScene extends Phaser.Scene {
  preload() {
    ...
    this.load.tilemapTiledJSON("map", "../assets/tilemaps/platformer-v2.json");
  }
  ...
  create() {
    ...
    map.createFromObjects("Powerups", tiles);

    // Instantiate a player instance at the location of the "Spawn Point" object in the Tiled map
    const spawnPoint = map.findObject("Objects", obj => obj.name === "Spawn Point");
    this.player = new Player(this, spawnPoint.x, spawnPoint.y);

    map.findObject("Powerups", obj => {
      console.log(obj);
      this.physics.add.overlap(this.player, obj, (e) => {
        this.parts += 5;
      });
    });
    ...
    this.add.text(512, 16, "Remaining parts : ", {
      font: "18px monospace",
      fill: "#000000",
      padding: { x: 20, y: 10 },
      backgroundColor: "#ffffff"
    ...
    this.remainingText = this.add.text(512 + 200, 16, this.parts.toString(), {
      font: "18px monospace",
      fill: "#000000",
      padding: {x: 20, y:10 },
      backgroundColor: "#ffffff"
  ...
  update(time, delta) {
    ...
    this.remainingText.text = this.parts.toString();
    ...
    if (pointer.isDown && 0 < this.parts && this.groundLayer.getTileAtWorldXY(worldPoint.x, worldPoint.y) === null) {
